...
RUN apt-get install -y -o Acquire::ForceIPv4=true wget git make gnupg nano
...
WORKDIR /test
RUN git clone https://github.com/imp/dnsmasq.git
WORKDIR /test/dnsmasq
RUN git checkout 15379ea1f252d1f53c5d93ae970b22dedb233642
